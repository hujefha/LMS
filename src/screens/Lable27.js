...
const Lable27 =()=>{
    ...
    <div class="ml-28 mt-5"><BsFillCheckCircleFill style={{backgroundColor:'green'}}></BsFillCheckCircleFill></div>
      ...
      <div class="border w-52 h-10 bg-blue-600 text-slate-100 pl-2 pt-2 ml-96 relative left-96 font-bold"><p>Continue to next Module</p></div>
