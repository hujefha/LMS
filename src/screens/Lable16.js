      ...
      <div><img src="/assets/bell.png" style={{width:55,marginLeft:'68%',marginTop:-56}}></img></div>
            ...
            <div>
               ...
               <div>
                   ...
                   <hr class="border-2 border-blue-500 w-24 ml-12 relative left-24 top-12 h-1 rounded-lg"></hr>
                   ...
                   <p class="text-sm ml-36 text-gray-500">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy <br></br>
                       ...
                       consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut</p>

                       <p class="font-bold relative left-96 ml-96 bottom-20">How to Submit</p>
                       <p class="text-sm text-gray-500 ml-96 relative left-80 bottom-16">Lorem ipsum dolor sit amet, consetetur sadipscing elitr,<br></br>
                            sed diam nonumy eirmod tempor invidunt.</p>
                        <button class="w-36 h-8 bg-blue-600 rounded-sm text-white relative left-96 ml-96 bottom-8">Submit assessment</button>
