...
const Lable25=()=>{
    return(
      ...
      <div class="border  w-96 h-10 ml-24"><p class="pl-10 pt-2">HTML,CSS and PHP</p><ImCheckboxUnchecked style={{marginTop:'-5%',marginLeft:'3%'}}></ImCheckboxUnchecked></div><br></br>
      <div class="border w-96 h-10 ml-24"><p class="pl-10 pt-2">HTML,CSS and Swift</p><ImCheckboxUnchecked style={{marginTop:'-5%',marginLeft:'3%',backgroundColor:'blue'}}></ImCheckboxUnchecked></div><br></br>
      <div class="border w-96 h-10 ml-24"><p class="pl-10 pt-2">HTML,CSS and PHP</p><ImCheckboxUnchecked style={{marginTop:'-5%',marginLeft:'3%',backgroundColor:'blue'}}></ImCheckboxUnchecked></div>
      <div class="w-36 h-10 bg-blue-600 rounded-sm text-zinc-50 pt-2 pl-3 relative left-96 mt-10"><p>Check Answers</p></div>
      <div class="text-zinc-600 ml-64 text-xl -mt-9"><p>Skip Question</p></div>
